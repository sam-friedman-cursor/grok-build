...
- Rust core or adaptive changes: `just test-rust`.
- Python binding changes: `just test-python`.
- Node.js binding changes: `just test-node`.
- Go binding changes: `just test-go`.
- Documentation changes: `just docs`; also run `just docs-linkcheck` when links change.
